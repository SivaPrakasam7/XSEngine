...
module.exports = {
    username: null, url: null, edata: null, data: { Screenshot: [] }, options: new chrome.Options(), dirver: 0,
    async scrap() {
        if (this.edata && this.username) {
            try {
                // Main loop
                ...
                this.data.performance = `${performance.now() - this.data.timestamp}ms`;
                this.driver.quit();
            }
